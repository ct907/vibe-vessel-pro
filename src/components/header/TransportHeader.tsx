      ...
      <div className="mx-auto max-w-6xl px-4 py-3 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2 justify-between">
          ...
          <Input
            ...
            className="text-center text-2xl h-10 flex-1 min-w-0 max-w-xs font-display bg-transparent border-0 border-b border-transparent rounded-none px-1 focus-visible:border-primary focus-visible:ring-0"
          />
