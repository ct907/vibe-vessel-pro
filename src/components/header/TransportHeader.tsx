  ...
  return (
    <>
      ...
      <div className="relative">
        ...
        <header id="main-header" className="noise-texture rounded-xl border border-border/60 mx-auto w-full max-w-[1600px]" style={{ boxShadow: "var(--shadow-paper)", background: "color-mix(in oklch, var(--card) 20%, transparent)", backdropFilter: theme === "light" ? "blur(8px) saturate(200%) opacity(20%)" : "blur(8px) saturate(200%)", WebkitBackdropFilter: theme === "light" ? "blur(8px) saturate(200%) opacity(20%)" : "blur(8px) saturate(200%)" }}>
